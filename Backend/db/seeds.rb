...
User.create(:username => "SeeRoseCode", :name => "RoseLake", :age => 31, :weight => 130, :height => "5'5", :email => "seerosecode@blah.com")
User.create(:username => "dekadekadeka", :name => "Deka", :age => 31, :weight => 135, :height => "5'5", :email => "dekadekadeka@blah.com")
